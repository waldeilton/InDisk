...
Namespace Server.Services
  ...
  ''' InDisk/Devio communication. Derived classes implement communication mechanisms and
  ...
  Public MustInherit Class DevioServiceBase
    ...
    ''' <summary>
    ''' Event raised when an InDisk Virtual Disk Device is created by with this instance.
    ''' </summary>
    Public Event InDiskCreated As Action
    Protected Overridable Sub OnInDiskCreated()
      RaiseEvent InDiskCreated()
    End Sub
    ...
    ''' but before associated virtual disk device is forcefully removed, as specified by ForceRemoveInDiskDeviceOnCrash
    ''' property.
    ''' </summary>
    ...
    Protected Overridable Sub OnServiceUnhandledException(e As UnhandledExceptionEventArgs)
      ...
      If HasInDiskDevice AndAlso ForceRemoveInDiskDeviceOnCrash Then
        InDiskAPI.ForceRemoveDevice(InDiskDeviceNumber)
      End If
    End Sub
    ...
    ''' <summary>
    ''' Creates a new service instance with enough data to later run a service that acts as server end in InDisk/Devio
    ''' communication.
    ''' </summary>
    ...
    Protected Overridable Function GetDeviceReader() As DLL.InDiskReadFileUnmanagedProc
    ...
    Public Overridable Function GetPartitionInformation() As ReadOnlyCollection(Of NativeFileIO.Win32API.PARTITION_INFORMATION)
      ...
      Return InDiskAPI.GetPartitionInformation(Nothing, GetDeviceReader(), SectorSize, Offset)

    End Function

    ''' <summary>
    ''' When overridden in a derived class, runs service that acts as server end in InDisk/Devio communication. It will
    ...
    ''' <summary>
    ''' Combines a call to StartServiceThread() with a call to InDiskAPI to create a proxy type
    ''' InDisk Virtual Disk Device that uses the started service as storage backend.
    ''' </summary>
    ''' <param name="Flags">Flags to pass to InDiskAPI.CreateDevice() combined with fixed flag
    ...
    ''' need to be specified in this parameter. A common value to pass however, is InDiskFlags.ReadOnly
    ...
    Public Overridable Sub StartServiceThreadAndMountInDisk(Flags As InDiskFlags, MountPoint As String)
      ...
      Try
        InDiskAPI.CreateDevice(DiskSize,
                               0,
                               0,
                               SectorSize,
                               Offset,
                               Flags Or InDiskAdditionalFlags Or InDiskProxyModeFlags,
                               InDiskProxyObjectName,
                               False,
                               MountPoint,
                               _InDiskDeviceNumber,
                               Nothing)
    ...
    ''' <summary>
    ''' Dismounts an InDisk Virtual Disk Device created by StartServiceThreadAndMountInDisk() and waits
    ''' for service thread of this instance to exit.
    ''' </summary>
    Public Overridable Sub DismountInDiskAndStopServiceThread()

      Dim i = 1
      Do
        Try
          InDiskAPI.RemoveDevice(_InDiskDeviceNumber)
          Exit Do
    ...
    ''' <summary>
    ''' Additional flags that will be passed to InDiskAPI.CreateDevice() in StartServiceThreadAndMountInDisk()
    ''' method. Default value of this property depends on derived class and which parameters are normally
    ''' needed for InDisk to start communication with this service.
    ''' </summary>
    ''' <value>Default value of this property depends on derived class and which parameters are normally
    ''' needed for InDisk to start communication with this service.</value>
    ''' <returns>Default value of this property depends on derived class and which parameters are normally
    ''' needed for InDisk to start communication with this service.</returns>
    Public Overridable Property InDiskAdditionalFlags As InDiskFlags

    ''' <summary>
    ''' When overridden in a derived class, indicates additional flags that will be passed to
    ''' InDiskAPI.CreateDevice() in StartServiceThreadAndMountInDisk() method. Value of this property depends
    ''' on derived class and which parameters are normally needed for InDisk to start communication with this
    ''' service.
    ''' </summary>
    ''' <value>Default value of this property depends on derived class and which parameters are normally
    ''' needed for InDisk to start communication with this service.</value>
    ''' <returns>Default value of this property depends on derived class and which parameters are normally
    ''' needed for InDisk to start communication with this service.</returns>
    Protected MustOverride ReadOnly Property InDiskProxyModeFlags As InDiskFlags

    ''' <summary>
    ''' Object name that InDisk Virtual Disk Driver can use to connect to this service.
    ''' </summary>
    ''' <value>Object name string.</value>
    ''' <returns>Object name that InDisk Virtual Disk Driver can use to connect to this service.</returns>
    Protected MustOverride ReadOnly Property InDiskProxyObjectName As String

    Private _InDiskDeviceNumber As UInteger = UInteger.MaxValue

    ''' <summary>
    ''' After successful call to StartServiceThreadAndMountInDisk(), this property returns InDisk device
    ''' number for created InDisk Virtual Disk Device. This number can be used when calling InDisk API
    ''' functions. If no InDisk Virtual Disk Device has been created by this instance, an exception is
    ''' thrown. Use HasInDiskDevice property to find out if an InDisk device has been created.
    ''' </summary>
    ''' <value>InDisk device
    ''' number for created InDisk Virtual Disk Device.</value>
    ''' <returns>InDisk device
    ''' number for created InDisk Virtual Disk Device.</returns>
    ''' <remarks></remarks>
    Public Overridable ReadOnly Property InDiskDeviceNumber As UInteger
      Get
        If _InDiskDeviceNumber = UInteger.MaxValue Then
          Throw New IOException("No InDisk Virtual Disk Device currently associated with this instance.")
        End If
        Return _InDiskDeviceNumber
      End Get
    End Property

    ''' <summary>
    ''' Use HasInDiskDevice property to find out if an InDisk device has been created in a call to
    ''' StartServiceThreadAndMountInDisk() method. Use InDiskDeviceNumber property to find out InDisk
    ''' device number for created device.
    ''' </summary>
    ''' <value>Returns True if an InDisk Virtual Disk Device has been created, False otherwise.</value>
    ''' <returns>Returns True if an InDisk Virtual Disk Device has been created, False otherwise.</returns>
    Public Overridable ReadOnly Property HasInDiskDevice As Boolean
      Get
        Return _InDiskDeviceNumber <> UInteger.MaxValue
      End Get
    End Property

    ''' <summary>
    ''' Indicates whether InDisk Virtual Disk Device created by this instance will be automatically
    ''' forcefully removed if a crash occurs in service thread of this instance. Default is True.
    ''' </summary>
    ''' <value>Indicates whether InDisk Virtual Disk Device created by this instance will be automatically
    ''' forcefully removed if a crash occurs in service thread of this instance. Default is True.</value>
    ''' <returns>Indicates whether InDisk Virtual Disk Device created by this instance will be automatically
    ''' forcefully removed if a crash occurs in service thread of this instance. Default is True.</returns>
    Public Overridable Property ForceRemoveInDiskDeviceOnCrash As Boolean = True
