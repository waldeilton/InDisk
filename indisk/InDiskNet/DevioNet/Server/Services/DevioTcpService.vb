...
Namespace Server.Services
  ...
  ''' <summary>
  ''' Class that implements server end of InDisk/Devio TCP/IP based communication protocol.
  ...
  Public Class DevioTcpService
    ...
    ''' <summary>
    ''' Runs service that acts as server end in InDisk/Devio TCP/IP based communication. It will first wait for
    ...
    Public Overrides Sub RunService()
      ...
      Try
        ...
        Do
          ...
          Dim RequestCode As INDPROXY_REQ

          Try
            RequestCode = CType(Reader.ReadUInt64(), INDPROXY_REQ)
    ...
    Private Sub SendInfo(Writer As BinaryWriter)
      ...
      Writer.Write(CULng(If(DevioProvider.CanWrite, INDPROXY_FLAGS.INDPROXY_FLAG_NONE, INDPROXY_FLAGS.INDPROXY_FLAG_RO)))
    ...
    Protected Overrides ReadOnly Property InDiskProxyModeFlags As InDiskFlags
      Get
        Return InDiskFlags.TypeProxy Or InDiskFlags.ProxyTypeTCP
      End Get
    End Property
