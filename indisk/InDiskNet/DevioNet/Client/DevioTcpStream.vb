  ...
  Public Class DevioTcpStream
    ...
    Public Sub New(name As String, read_only As Boolean)
      ...
      Try
        ...
        Writer.Write(INDPROXY_REQ.INDPROXY_REQ_INFO)
        Writer.Flush()
        ...
        Flags = Flags Or CType(Reader.ReadInt64(), INDPROXY_FLAGS)
    ...
    Public Overrides Function Read(buffer As Byte(), offset As Integer, count As Integer) As Integer
      ...
      Writer.Write(INDPROXY_REQ.INDPROXY_REQ_READ)
    ...
    Public Overrides Sub Write(buffer As Byte(), offset As Integer, count As Integer)
      ...
      Writer.Write(INDPROXY_REQ.INDPROXY_REQ_WRITE)
      Writer.Write(Position)
      Writer.Write(CLng(count))
