Namespace InDisk
  ...
  ''' <summary>
  ''' Base class that represents InDisk Virtual Disk Driver created device objects.
  ''' </summary>
  <Guid("797bbe31-0d5a-4225-8139-385539c5ce7e")>
  <ClassInterface(ClassInterfaceType.AutoDual)>
  Public Class InDiskObject
    ...
    ''' <summary>
    ''' Encapsulates a handle in a new InDiskObject.
    ''' </summary>
    ...
    ''' <summary>
    ''' Checks if version of running InDisk Virtual Disk Driver servicing this device object is compatible with this API
    ''' library. If this device object is not created by InDisk Virtual Disk Driver this method returns False.
    ''' </summary>
    Public Function CheckDriverVersion() As Boolean

      Return DLL.InDiskCheckDriverVersion(SafeFileHandle)
