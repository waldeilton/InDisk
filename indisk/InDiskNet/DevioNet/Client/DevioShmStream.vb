  ...
  Public Class DevioShmStream
    ...
    Public Sub New(name As String, read_only As Boolean)
      ...
      Try
        ...
        MapView.Write(&H0, INDPROXY_REQ.INDPROXY_REQ_INFO)
        ...
        Dim Response = MapView.Read(Of INDPROXY_INFO_RESP)(&H0)
    ...
    Public Overrides Sub Close()
      ...
      If MapView IsNot Nothing AndAlso RequestEvent IsNot Nothing Then
        Try
          MapView.Write(&H0, INDPROXY_REQ.INDPROXY_REQ_CLOSE)
          RequestEvent.Set()
    ...
    Public Overrides Function Read(buffer As Byte(), offset As Integer, count As Integer) As Integer
      ...
      Dim Request As INDPROXY_READ_REQ
      Request.request_code = INDPROXY_REQ.INDPROXY_REQ_READ
      ...
      Dim Response = MapView.Read(Of INDPROXY_READ_RESP)(&H0)
      If Response.errorno <> 0 Then
        Throw New EndOfStreamException("Read error: " & Response.errorno)
      End If
      Dim Length = CInt(Response.length)

      MapView.ReadArray(CULng(INDPROXY_HEADER_SIZE), buffer, offset, Length)
      Position += Length
      Return Length
    ...
    Public Overrides Sub Write(buffer As Byte(), offset As Integer, count As Integer)
      ...
      Dim Request As INDPROXY_WRITE_REQ
      Request.request_code = INDPROXY_REQ.INDPROXY_REQ_WRITE
      Request.offset = CULng(Position)
      Request.length = CULng(count)

      MapView.Write(&H0, Request)

      MapView.WriteArray(CULng(INDPROXY_HEADER_SIZE), buffer, offset, count)
      ...
      Dim Response = MapView.Read(Of INDPROXY_WRITE_RESP)(&H0)
      If Response.errorno <> 0 Then
