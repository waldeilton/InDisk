Namespace Client
  ...
  ''' <summary>
  ''' Base class for classes that implement Stream for client side of InDisk/Devio protocol.
  ''' </summary>
  Public MustInherit Class DevioStream
    ...
    ''' <summary>
    ''' InDisk proxy flags specified for proxy connection.
    ''' </summary>
    Protected Flags As INDPROXY_FLAGS
    ...
    Protected Sub New(name As String, read_only As Boolean)
      ObjectName = name
      If read_only Then
        Flags = INDPROXY_FLAGS.INDPROXY_FLAG_RO
      End If
    End Sub

    ''' <summary>
    ''' Indicates whether Stream is readable. This implementation returns a
    ''' constant value of True, because InDisk/Devio proxy implementations are
    ''' always readable.
    ''' </summary>
    ...
    ''' unless ProxyFlags property contains INDPROXY_FLAGS.INDPROXY_FLAG_RO value.
    ''' </summary>
    Public Overrides ReadOnly Property CanWrite As Boolean
      Get
        Return (Flags And INDPROXY_FLAGS.INDPROXY_FLAG_RO) = 0
      End Get
    End Property
    ...
    ''' InDisk proxy flags specified for proxy connection.
    ''' </summary>
    Public ReadOnly Property ProxyFlags As INDPROXY_FLAGS
      Get
        Return Flags
      End Get
    End Property
